...
public class ClientController {
    ...
    @PutMapping("/update")
    @ResponseStatus(HttpStatus.CREATED)
    public Client actualizaClient(@RequestBody Client client) {
        return clientService.actualizaClient(client);
    }

    @DeleteMapping("/{idClient}")
    @ResponseStatus(HttpStatus.NO_CONTENT)
    public boolean borrarClient(@PathVariable("idClient") int clientId) {
